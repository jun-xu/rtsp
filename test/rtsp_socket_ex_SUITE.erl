...
test_common(_) ->
	...
	Options = <<"OPTIONS rtsp://127.0.0.1:65000/files/9min.avi RTSP/1.0\r\n",
				"CSeq: 2\r\n",
	...
	%% second, discribe.
	Discribe = <<"DESCRIBE rtsp://127.0.0.1:65000/files/9min.avi RTSP/1.0\r\n",
				 "CSeq: 3\r\n",
				 "User-Agent: LibVLC/2.1.2 (LIVE555 Streaming Media v2013.12.05)\r\n",
	...
	%% third, setup.
	Setup = <<"SETUP rtsp://10.3.0.86:65000/files/9min.avi/trackID=0 RTSP/1.0\r\n",
			  "CSeq: 4\r\nUser-Agent: LibVLC/2.1.2 (LIVE555 Streaming Media v2013.12.05)\r\n",
